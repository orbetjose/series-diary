  ...
  const filteredSeries = useMemo(() => {
    if (filters.year === "all") {
      return allSeries.filter((serie) => {
        ...
        if (filters.type.length > 0 && !filters.type.includes(finishedType)) return false;
          ...
          {filters.year.length > 0 && (
            <div className="grid grid-cols-2 gap-2">
              <Field orientation="horizontal">
                <Checkbox onCheckedChange={() => handleSelectChange("serie", "type")}/>
                <Label>Serie</Label>
              </Field>
              <Field orientation="horizontal">
                <Checkbox onCheckedChange={() => handleSelectChange("miniserie", "type")}/>
                <Label>Miniserie</Label>
              </Field>
              <Field orientation="horizontal">
                <Checkbox onCheckedChange={() => handleSelectChange("película", "type")}/>
                <Label>Película</Label>
              </Field>
              <Field orientation="horizontal">
                <Checkbox onCheckedChange={() => handleSelectChange("documental", "type")}/>
            ...
            {paginatedSeries.length > 0 &&
              paginatedSeries.map((serie) => (
                <TableRow key={serie.id}>
                  ...
                  <TableCell>{serie.season ? serie.season : "-"}</TableCell>
                  <TableCell>
                    <DropdownMenu>
